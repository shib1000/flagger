...
import (
	...
	v1beta1 "github.com/fluxcd/flagger/pkg/client/listers/kapcom/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KapcomV1beta1().IngressRoutes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KapcomV1beta1().IngressRoutes(namespace).Watch(context.TODO(), options)
			},
		},
		&kapcomv1beta1.IngressRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *ingressRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kapcomv1beta1.IngressRoute{}, f.defaultInformer)
}
